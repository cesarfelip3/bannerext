...
class Ecommerceguys_Cattopbanners_Adminhtml_CattopbannersController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			Mage::getSingleton('adminhtml/session')->addError(Mage::helper('cattopbanners')->__('Item does not exist'));
			$this->_redirect('*/*/');
		}
	}
	...
	public function saveAction() {
		if ($data = $this->getRequest()->getPost()) {
			...
			try {
				...
				$model->save();
				Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('cattopbanners')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('cattopbanners')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
	}
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('cattopbanners/adminhtml_cattopbanners_grid')
            ->getCsv();
