 ...
 */
class Ecommerceguys_Cattopbanners_Block_Adminhtml_Cattopbanners_Edit_Tab_Websites extends Mage_Adminhtml_Block_Store_Switcher
{
    ...
    {
        parent::__construct();
        $this->setTemplate('cattopbanners/edit/websites.phtml');
    }
    ...
    {
        return Mage::registry('cattopbanners_data');
    }
    ...
    {
        return $this->getBanner()->getStoreId();
    }
    ...
    {
        return $this->getBanner()->getWebsiteIds();
    }
    ...
    {
        return in_array($websiteId, $this->getBanner()->getWebsiteIds());
    }
    ...
    {
        return $this->getBanner()->getWebsitesReadonly();
    }
